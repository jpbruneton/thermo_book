...
C'est énorme, et explique la part importante du chauffage de l'eau dans le bilan énergétique mondial.
On remarque aussi que la capacité thermique de l'eau est très grande,
en particulier vis-à-vis de celle des métaux (environ 10 fois plus grande, cf. exercices suivants).
...
d’environ \(500\,\text{L}\). La transpiration ayant principalement
...
On donne la chaleur latente de vaporisation de l'eau à pression atmosphérique :
\[
\begin{aligned}
...
\begin{enumerate}
  ...
  \item Pour comparaison, on considère un climatiseur alimenté par une puissance électrique $P_{\text{élec}}=2{,}0\times10^3\,\text{W}$, de coefficient de performance frigorifique $\mathrm{COP}=3{,}0$, refroidissant une pièce de surface $A_{\text{pièce}}=20\,\text{m}^2$. Par définition,
\[
...
\begin{solution}
\textbf{1.} Le volume évapotranspiré vaut $500\,\text{L}=5{,}0\times10^{-1}\,\text{m}^3$. En prenant $\rho_{\text{eau}}=1{,}0\times10^3\,\text{kg}\!\cdot\!\text{m}^{-3}$, la masse d'eau correspondante est
\[
m=\rho_{\text{eau}}V
...
\textbf{2.} La vaporisation est un changement d'état endothermique : elle nécessite l'énergie $Q_{\text{évap}}$, prélevée sur les feuilles, le sol et l'air environnant. Cette extraction de chaleur abaisse la température des feuilles et de leur environnement immédiat, d'où l'effet refroidissant de l'évapotranspiration.
...
\[
P_{\text{arbre}}=\frac{Q_{\text{évap}}}{\tau}
...
\]
Cette valeur est du même ordre de grandeur que celle obtenue pour l'arbre, $5{,}7\times10^2\,\text{W}\!\cdot\!\text{m}^{-2}$. Dans ce modèle, la puissance latente de l'arbre par unité de surface est environ deux fois plus grande que la puissance frigorifique du climatiseur par unité de surface de la pièce.

\textbf{5.} La comparaison porte uniquement sur des flux d'énergie. Le climatiseur refroidit un volume fermé et contrôlé, tandis que la vapeur produite par l'arbre se disperse dans l'atmosphère. Une partie de l'énergie d'évaporation est prélevée au sol et aux feuilles plutôt que directement à l'air situé sous le feuillage. La transpiration varie aussi avec l'ensoleillement, le vent, l'humidité de l'air, l'espèce et l'eau disponible ; elle peut fortement diminuer en période de sécheresse. Inversement, l'arbre apporte également de l'ombre, ce qui réduit directement le rayonnement solaire reçu par le sol et les personnes. Les puissances calculées permettent donc une comparaison d'ordre de grandeur, mais pas une équivalence exacte de confort thermique.
