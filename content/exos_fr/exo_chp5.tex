...
$\Gamma_1$ et $\Gamma_2$ dans le diagramme de Clapeyron $(V,P)$. Indiquer
...
et $D$ celui du chemin $\Gamma_2$. Leurs coordonnées dans le diagramme
$(V,P)$ sont
\[
\begin{aligned}
A&=\left(V_1,\frac{nRT_1}{V_1}\right),&
C&=\left(V_2,\frac{nRT_1}{V_2}\right),\\
D&=\left(V_1,\frac{nRT_2}{V_1}\right),&
B&=\left(V_2,\frac{nRT_2}{V_2}\right).
\end{aligned}
\]
