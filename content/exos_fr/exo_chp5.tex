...
On reprend l'exercice \textit{Compression adiabatique : progressive ou brutale} de la leçon 4 : $n = 0{,}50$ mol d'hélium ($\gamma = 5/3$) dans un cylindre calorifugé, initialement à $T_0 = 300$ K, $P_0 = 1{,}0$ bar, $V_0 = 12{,}5$ L. On rappelle les résultats :
\begin{itemize}
