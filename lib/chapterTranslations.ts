...
export const chapterTranslations: Record<Exclude<Lang, "fr" | "en">, ThemeTranslations> = {
  ...
  es: {
    ...
    "second-principe": {
      ...
      topics: ["Segundo principio", "Entropía", "Reversibilidad", "Irreversibilidad", "Creación de entropía", "Evolución espontánea"],
    },
    "relations-fondamentales": {
    ...
    "transitions-de-phases": {
      ...
      topics: [
        ...
        "Isotermas",
        "Regla de la palanca de Maxwell",
        "Curva de saturación",
      ],
    },
    "machines-thermiques": {
    ...
    climat: {
      ...
      topics: ["Balance radiativo", "Efecto invernadero", "Motor atmosférico", "Entropía climática"],
    },
    "thermodynamique-quantique": {
      title: "Termodinámica cuántica",
      description: "Trabajo, calor y entropía a escala cuántica.",
      topics: ["Motores cuánticos", "Fluctuaciones cuánticas", "Relación de Jarzynski", "Termodinámica de la información cuántica"],
  ...
  pt: {
    ...
    "second-principe": {
      ...
      topics: ["Segundo princípio", "Entropia", "Reversibilidade", "Irreversibilidade", "Criação de entropia", "Evolução espontânea"],
    },
    "relations-fondamentales": {
    ...
    climat: {
      ...
      topics: ["Balanço radiativo", "Efeito estufa", "Motor atmosférico", "Entropia climática"],
    },
    "thermodynamique-quantique": {
      title: "Termodinâmica quântica",
      description: "Trabalho, calor e entropia na escala quântica.",
      topics: ["Motores quânticos", "Flutuações quânticas", "Relação de Jarzynski", "Termodinâmica da informação quântica"],
  ...
  it: {
    ...
    "relations-fondamentales": {
      ...
      topics: [
        ...
        "Rappresentazione energia",
        "Rappresentazione entropia",
    ...
    climat: {
      ...
      topics: ["Bilancio radiativo", "Effetto serra", "Motore atmosferico", "Entropia climatica"],
    },
    "thermodynamique-quantique": {
      title: "Termodinamica quantistica",
      description: "Lavoro, calore ed entropia su scala quantistica.",
      topics: ["Motori quantistici", "Fluttuazioni quantistiche", "Relazione di Jarzynski", "Termodinamica dell'informazione quantistica"],
  ...
  pl: {
    ...
    climat: {
      ...
      topics: ["Bilans radiacyjny", "Efekt cieplarniany", "Silnik atmosferyczny", "Entropia klimatyczna"],
    },
    "thermodynamique-quantique": {
      title: "Termodynamika kwantowa",
      description: "Praca, ciepło i entropia w skali kwantowej.",
      topics: ["Silniki kwantowe", "Fluktuacje kwantowe", "Relacja Jarzynskiego", "Termodynamika informacji kwantowej"],
  ...
  ru: {
    ...
    "thermodynamique-quantique": {
      ...
      topics: ["Квантовые двигатели", "Квантовые флуктуации", "Соотношение Ярзинского", "Термодинамика квантовой информации"],
  ...
  zh: {
    ...
    "notions-fondamentales": {
      ...
      topics: ["平衡态", "第零定律", "热力学系统", "壁", "状态变量", "状态函数", "准静态过程", "储库", "广延性", "强度性"],
    },
    "premier-principe": {
      title: "能量守恒：热力学第一定律",
      description: "功、热、内能与第一定律。",
      topics: ["内能", "热传递", "第一定律", "功", "克拉珀龙图", "正循环", "逆循环"],
    },
    "second-principe": {
    ...
    "changements-de-variables": {
      ...
      topics: ["多元微分学", "勒让德变换", "热力学势", "自由能", "焓", "自由焓"],
    },
    coefficients: {
      title: "量热系数与热弹性系数",
    ...
    "machines-thermiques": {
      ...
      topics: ["热机", "蒸汽机", "双热源循环", "克劳修斯不等式", "卡诺循环", "效率", "性能系数", "TS图", "朗肯循环"],
    },
    "geometrie-differentielle": {
      title: "热力学中的微分几何",
    ...
    "thermodynamique-quantique": {
      ...
      topics: ["量子热机", "量子涨落", "贾辛斯基关系", "量子信息热力学"],
  ...
  ja: {
    ...
    "notions-fondamentales": {
      ...
      topics: ["平衡", "熱力学第零法則", "熱力学系", "壁", "状態変数", "状態関数", "準静的過程", "貯槽", "示量性", "示強性"],
    },
    "premier-principe": {
      title: "エネルギー保存：熱力学第一法則",
      description: "仕事、熱、内部エネルギー、そして第一法則。",
      topics: ["内部エネルギー", "熱移動", "熱力学第一法則", "仕事", "クラペイロン線図", "動作サイクル", "逆サイクル"],
    },
    "second-principe": {
    ...
    "changements-de-variables": {
      ...
      topics: ["多変数微分法", "ルジャンドル変換", "熱力学ポテンシャル", "自由エネルギー", "エンタルピー", "自由エンタルピー"],
    },
    coefficients: {
      title: "熱量係数と熱弾性係数",
    ...
    "machines-thermiques": {
      ...
      topics: ["熱機関", "蒸気機関", "二熱源サイクル", "クラウジウスの不等式", "カルノーサイクル", "効率", "成績係数", "TS線図", "ランキンサイクル"],
    },
    "geometrie-differentielle": {
      title: "熱力学における微分幾何学",
  ...
  ko: {
    introduction: {
      ...
      topics: ["열기관", "열-일 변환", "제2법칙", "엔트로피", "고온 저장체", "저온 저장체", "카르노 효율", "열역학의 보편성"],
    ...
    "notions-fondamentales": {
      ...
      topics: ["평형", "열역학 제0법칙", "열역학계", "벽", "상태변수", "상태함수", "준정적 과정", "저장체", "시량성", "시강성"],
    },
    "premier-principe": {
    ...
    "changements-de-variables": {
      ...
      topics: ["다변수 미분법", "르장드르 변환", "열역학 퍼텐셜", "자유 에너지", "엔탈피", "자유 엔탈피"],
    },
    coefficients: {
      title: "열량 계수와 열탄성 계수",
    ...
    "transitions-de-phases": {
      ...
      topics: ["상전이", "상평형 그림", "임계점", "불안정성", "반데르발스 기체", "등온선", "맥스웰 등면적 법칙", "포화 곡선"],
    },
    "machines-thermiques": {
      title: "열기관",
      description: "이열원 사이클, 카르노 사이클, 효율, 그리고 제2법칙의 여러 표현.",
      topics: ["열기관", "증기기관", "이열원 사이클", "클라우지우스 부등식", "카르노 사이클", "효율", "성능계수", "TS 선도", "랭킨 사이클"],
    },
    "geometrie-differentielle": {
      title: "열역학의 미분기하학",
  ...
  hi: {
    ...
    "second-principe": {
      ...
      topics: ["द्वितीय नियम", "एन्ट्रॉपी", "प्रतिवर्तनीयता", "अप्रतिवर्तनीयता", "एन्ट्रॉपी उत्पादन", "स्वतःस्फूर्त विकास"],
    },
    "relations-fondamentales": {
    ...
    "changements-de-variables": {
      ...
      topics: ["बहुचर अवकल गणना", "लेजांड्र रूपांतरण", "ऊष्मागतिक विभव", "मुक्त ऊर्जा", "एन्थैल्पी", "मुक्त एन्थैल्पी"],
    },
    coefficients: {
    ...
    "demon-de-maxwell": {
      ...
      topics: ["मैक्सवेल का दानव", "एन्ट्रॉपी और सूचना", "लैंडाउर सिद्धांत", "सूचना मिटाना"],
    },
    endoreversibilite: {
    ...
    "thermodynamique-hors-equilibre": {
      ...
      topics: ["रैखिक ऊष्मागतिकी", "ऑन्सागर संबंध", "व्युत्क्रमता", "एन्ट्रॉपी उत्पादन", "युग्मित परिघटनाएँ"],
    },
    climat: {
      title: "जलवायु विज्ञान और ऊष्मागतिकी",
      description: "पृथ्वी की जलवायु प्रणाली पर ऊष्मागतिक अनुप्रयोग।",
      topics: ["विकिरण संतुलन", "ग्रीनहाउस प्रभाव", "वायुमंडलीय इंजन", "जलवायु एन्ट्रॉपी"],
    },
    "thermodynamique-quantique": {
      title: "क्वांटम ऊष्मागतिकी",
      description: "क्वांटम स्तर पर कार्य, ऊष्मा और एन्ट्रॉपी।",
      topics: ["क्वांटम इंजन", "क्वांटम उतार-चढ़ाव", "यार्ज़िंस्की संबंध", "क्वांटम सूचना ऊष्मागतिकी"],
  ...
  vi: {
    ...
    "changements-de-variables": {
      ...
      topics: ["Phép tính vi phân nhiều biến", "Biến đổi Legendre", "Thế nhiệt động", "Năng lượng tự do", "Enthalpy", "Enthalpy tự do"],
    },
    coefficients: {
    ...
    climat: {
      ...
      topics: ["Cân bằng bức xạ", "Hiệu ứng nhà kính", "Động cơ khí quyển", "Entropy khí hậu"],
    },
    "thermodynamique-quantique": {
      title: "Nhiệt động lực học lượng tử",
      description: "Công, nhiệt và entropy ở thang lượng tử.",
      topics: ["Động cơ lượng tử", "Thăng giáng lượng tử", "Hệ thức Jarzynski", "Nhiệt động lực học thông tin lượng tử"],
  ...
  ar: {
    ...
    "second-principe": {
      ...
      topics: ["المبدأ الثاني", "الإنتروبيا", "الانعكاسية", "اللاانعكاسية", "إنتاج الإنتروبيا", "التطور التلقائي"],
    },
    "relations-fondamentales": {
    ...
    "changements-de-variables": {
      ...
      topics: ["الحساب التفاضلي متعدد المتغيرات", "تحويل ليجاندر", "الكمونات الحرارية الديناميكية", "الطاقة الحرة", "الإنثالبي", "الإنثالبي الحر"],
    },
    coefficients: {
      title: "المعاملات الحرورية والحراري-المرنة",
      description: "المعاملات الحرورية، المعاملات الحراري-المرنة، ومعادلات الحالة.",
      topics: ["المعاملات الحرورية", "المعاملات الحراري-المرنة", "السعات الحرارية", "معادلة الحالة", "الطور غير القابل للانضغاط", "الاستقرار الحراري الديناميكي"],
    },
    "transitions-de-phases": {
    ...
    endoreversibilite: {
      ...
      topics: ["اللاعكوسية الداخلية", "مردود كرزون-ألبورن", "القدرة القصوى", "التحسين الحراري الديناميكي"],
    },
    thermoelectricite: {
      title: "الكهروحرارية",
      description: "التأثيرات الكهروحرارية وتحويل الطاقة.",
      topics: ["تأثير زيبك", "تأثير بلتييه", "تأثير طومسون", "معامل الجودة"],
    },
    "thermodynamique-hors-equilibre": {
      title: "الديناميكا الحرارية القريبة من التوازن",
      description: "الظواهر اللاانعكاسية وعلاقات أونساغر.",
      topics: ["الديناميكا الحرارية الخطية", "علاقات أونساغر", "التبادلية", "إنتاج الإنتروبيا", "الظواهر المترابطة"],
    },
    climat: {
      title: "علم المناخ والديناميكا الحرارية",
      description: "تطبيقات الديناميكا الحرارية على النظام المناخي للأرض.",
      topics: ["التوازن الإشعاعي", "تأثير الاحتباس الحراري", "المحرك الجوي", "الإنتروبيا المناخية"],
    },
    "thermodynamique-quantique": {
      title: "الديناميكا الحرارية الكمومية",
      description: "الشغل، الحرارة، والإنتروبيا على المقياس الكمومي.",
      topics: ["المحركات الكمومية", "التذبذبات الكمومية", "علاقة يارزينسكي", "ديناميكا حرارية للمعلومات الكمومية"],
