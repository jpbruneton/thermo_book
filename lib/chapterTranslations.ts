...
export const chapterTranslations: Record<Exclude<Lang, "fr" | "en">, ThemeTranslations> = {
  de: {
    ...
    "second-principe": {
      title: "Der zweite Hauptsatz der Thermodynamik",
      description: "Mit der Entropie die Richtung thermodynamischer Zustandsänderungen und die Grenzen von Wärmekraftmaschinen verstehen.",
      topics: [
        "Zweiter Hauptsatz",
        "Reversibilität",
        "Irreversibilität",
  ...
  es: {
    ...
    "second-principe": {
      title: "El segundo principio de la termodinámica",
      description: "Comprender el sentido de las transformaciones y los límites de las máquinas térmicas a través de la entropía.",
      topics: [
        "Segundo principio",
        "Reversibilidad",
        "Irreversibilidad",
  ...
  pt: {
    ...
    "second-principe": {
      title: "O segundo princípio da termodinâmica",
      description: "Compreender o sentido das transformações e os limites das máquinas térmicas através da entropia.",
      topics: [
        "Segundo princípio",
        "Reversibilidade",
        "Irreversibilidade",
  ...
  it: {
    ...
    "second-principe": {
      ...
      description: "Comprendere il verso delle trasformazioni e i limiti delle macchine termiche attraverso l'entropia.",
      topics: [
        "Secondo principio",
        "Reversibilità",
        "Irreversibilità",
  ...
  pl: {
    ...
    "second-principe": {
      title: "Druga zasada termodynamiki",
      description: "Zrozumieć kierunek przemian i ograniczenia silników cieplnych dzięki entropii.",
      topics: [
        "Druga zasada",
        "Odwracalność",
        "Nieodwracalność",
  ...
  ru: {
    ...
    "second-principe": {
      title: "Второе начало термодинамики",
      description: "Понять направление термодинамических процессов и пределы возможностей тепловых машин с помощью энтропии.",
      topics: [
        "Второе начало",
        "Обратимость",
        "Необратимость",
  ...
  zh: {
    ...
    "second-principe": {
      title: "热力学第二定律",
      description: "通过熵理解热力学过程的方向和热机的极限。",
      topics: [
        "第二定律",
        "可逆性",
        "不可逆性",
  ...
  ja: {
    ...
    "second-principe": {
      title: "熱力学第二法則",
      description: "エントロピーを通じて、状態変化の方向と熱機関の限界を理解する。",
      topics: [
        "熱力学第二法則",
        "可逆性",
        "不可逆性",
  ...
  ko: {
    ...
    "second-principe": {
      title: "열역학 제2법칙",
      description: "엔트로피를 통해 열역학적 과정의 방향과 열기관의 한계를 이해한다.",
      topics: [
        "열역학 제2법칙",
        "가역성",
        "비가역성",
  ...
  hi: {
    ...
    "second-principe": {
      title: "ऊष्मागतिकी का द्वितीय नियम",
      description: "एंट्रॉपी के माध्यम से ऊष्मागतिक प्रक्रियाओं की दिशा और ऊष्मा इंजनों की सीमाओं को समझना।",
      topics: [
        "द्वितीय नियम",
        "प्रतिवर्तनीयता",
        "अप्रतिवर्तनीयता",
  ...
  vi: {
    ...
    "second-principe": {
      title: "Định luật thứ hai của nhiệt động lực học",
      description: "Hiểu chiều diễn biến của các quá trình và giới hạn của động cơ nhiệt thông qua entropy.",
      topics: [
        "Định luật thứ hai",
        "Tính thuận nghịch",
  ...
  ar: {
    ...
    "second-principe": {
      title: "المبدأ الثاني للديناميكا الحرارية",
      description: "فهم اتجاه التحولات وحدود أداء المحركات الحرارية من خلال الإنتروبيا.",
      topics: [
        "المبدأ الثاني",
        "العكوسية",
        "اللاعكوسية",
  ...
  id: {
    ...
    "second-principe": {
      ...
      description: "Memahami arah proses termodinamika dan batas kemampuan mesin kalor melalui entropi.",
      topics: [
        "Hukum kedua",
        "Reversibilitas",
        "Irreversibilitas",
  ...
  tr: {
    ...
    "second-principe": {
      title: "Termodinamiğin İkinci Yasası",
      description: "Entropi aracılığıyla termodinamik süreçlerin yönünü ve ısı makinelerinin sınırlarını anlamak.",
      topics: [
        "İkinci yasa",
        "Tersinirlik",
        "Tersinmezlik",
  ...
  bn: {
    ...
    "second-principe": {
      title: "তাপগতিবিদ্যার দ্বিতীয় সূত্র",
      description: "এনট্রপির মাধ্যমে তাপগতীয় প্রক্রিয়ার দিক এবং তাপ ইঞ্জিনের সীমাবদ্ধতা বোঝা।",
      topics: [
        "দ্বিতীয় সূত্র",
        "প্রত্যাবর্তনযোগ্যতা",
        "অপ্রত্যাবর্তনযোগ্যতা",
        "কার্নো দক্ষতা",
        "কার্নো চক্র",
        "ক্লসিয়ুস অসমতা",
        "এনট্রপি",
  ...
  ur: {
    ...
    "second-principe": {
      title: "حر حرکیات کا دوسرا اصول",
      description: "اینٹروپی کے ذریعے حر حرکیاتی عمل کی سمت اور حرارتی انجنوں کی حدود کو سمجھنا۔",
      topics: [
        "دوسرا اصول",
        "برگشت پذیری",
        "ناقابلِ برگشت پذیری",
  ...
  sw: {
    ...
    "second-principe": {
      title: "Kanuni ya Pili ya Thermodinamiki",
      description: "Kuelewa mwelekeo wa michakato ya thermodinamiki na mipaka ya injini za joto kupitia entropy.",
      topics: [
        "Kanuni ya pili",
        "Uwezekano wa kurudi",
        "Kutowezekana kurudi",
  ...
  fa: {
    ...
    "second-principe": {
      title: "قانون دوم ترمودینامیک",
      description: "درک جهت فرایندهای ترمودینامیکی و محدودیت‌های موتورهای گرمایی به کمک آنتروپی.",
      topics: [
        "قانون دوم",
        "برگشت‌پذیری",
        "برگشت‌ناپذیری",
