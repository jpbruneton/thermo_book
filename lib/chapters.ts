...
import { bookMeta } from "./bookMetadata";
export { bookMeta, contactEmail } from "./bookMetadata";
...
export const themes: Theme[] = [
  ...
  makeLecon({
    ...
    titleFr: "Le second principe de la thermodynamique",
    titleEn: "The Second Law of Thermodynamics",
    descriptionFr: "Comprendre le sens des transformations et les limites des machines thermiques grâce à l’entropie.",
    descriptionEn: "Understanding the direction of thermodynamic processes and the limits of heat engines through entropy.",
    readingTime: "20 min",
    topicsFr: [
      "Second principe",
      "Réversibilité",
  ...
  makeLecon({
    ...
    descriptionFr: "Relier chaleur, dilatation et compressibilité aux propriétés mesurables et à la stabilité.",
    descriptionEn: "Connecting heat, expansion, and compressibility to measurable properties and stability.",
    readingTime: "30 min",
    topicsFr: [
  ...
  makeLecon({
    ...
    titleFr: "Les potentiels thermodynamiques",
    titleEn: "Thermodynamic Potentials",
    descriptionFr: "Choisir le potentiel adapté aux contraintes pour déterminer l'équilibre et le travail disponible.",
    descriptionEn: "Thermodynamic potentials, experimental constraints, equilibrium, and available work.",
    readingTime: "30 min",
    topicsFr: [
