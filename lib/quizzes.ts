...
export const quizQuestions: QuizQuestion[] = [
  ...
  },
  {
    ...
    choices: [
      ...
      "Parce que la source froide doit nécessairement condenser le fluide pour permettre au moteur de recommencer son cycle.",
    ],
    explanations: [
      ...
      "Faux : un moteur thermique peut fonctionner sans changement d'état du fluide. La condensation n'est pas une condition générale.",
    ],
    correctIndex: 0,
  },
  {
  ...
  },
  {
    ...
    choices: [
      ...
      "L'observation que des corps de même masse nécessitent des quantités de chaleur différentes pour une même élévation de température.",
    ],
    explanations: [
      ...
      "Faux : des capacités thermiques différentes sont compatibles avec la théorie du calorique ; cette observation ne la réfute pas.",
    ],
    correctIndex: 0,
  },
  {
  ...
  },
  {
    ...
    choices: [
      "La chaleur nécessaire pour élever d'un degré la température du corps entier.",
      "La quantité de chaleur qu'il faut fournir à une unité de masse du corps pour élever sa température d'un degré.",
      "La chaleur nécessaire pour faire fondre une unité de masse du corps à température constante.",
    ],
    explanations: [
      "Faux : cela définit la capacité thermique C = mc du corps entier ; c est rapportée à une unité de masse.",
      ...
      "Faux : cela définit la chaleur massique latente de fusion L, pas la capacité thermique massique c.",
    ],
    correctIndex: 1,
  },
  {
    ...
    choices: ["Environ 1 J par calorie", "Environ 4,18 J par calorie", "Environ 4 180 J par calorie", "Environ 0,24 J par calorie"],
    explanations: [
      ...
      "Faux : environ 4 180 J correspondent à une kilocalorie, soit 1 000 calories.",
  ...
  },
  {
    id: "l2-q6",
    lecon: 2,
    question: "Un emballage alimentaire indique « 250 kcal ». À combien de joules cela correspond-il approximativement ?",
    choices: ["≈ 250 J", "≈ 1046 kJ", "≈ 1046 J", "≈ 250 kJ"],
    explanations: [
      "Faux : cela reviendrait à confondre l'unité indiquée avec le joule.",
      "Exact : 1 kcal = 1 000 cal. L'énergie indiquée vaut environ 1 046 kJ.",
      "Faux : cela correspond à 250 cal, et non à 250 kcal. Le préfixe kilo représente un facteur 1 000.",
  ...
  },
  {
    ...
    lecon: 2,
    question:
      "Un glaçon de masse m à 0°C est chauffé jusqu'à obtenir de l'eau liquide à 20°C. On note L la chaleur massique latente de fusion, c_eau et c_glace les capacités thermiques massiques de l'eau liquide et de la glace, et ΔT = 20°C. Quelle expression donne la chaleur totale reçue Q ?",
    choices: [
      "Q = m c_eau ΔT",
      "Q = m L + m c_eau ΔT",
      "Q = m L + m c_glace ΔT",
    ...
    explanations: [
      ...
      "Faux : la fusion est bien comptée, mais l'échauffement de 0°C à 20°C concerne l'eau liquide. Il faut utiliser c_eau, pas c_glace.",
    ],
    correctIndex: 1,
  },
  {
  ...
  // ─── Leçon 3 : Notions fondamentales ───
  {
    id: "l3-q1",
    lecon: 3,
    question: "On n'envisage que le travail des forces de pression. Quelles propriétés des parois assurent l'isolement du système ?",
    choices: [
      "Rigides, adiabatiques et perméables.",
      "Rigides, adiabatiques et imperméables.",
      "Rigides, diathermanes et imperméables.",
      "Mobiles, adiabatiques et imperméables.",
    ],
    explanations: [
      "Faux : des parois perméables permettent un échange de matière, même si elles sont rigides et adiabatiques.",
      ...
      "Faux : des parois mobiles permettent un échange de travail des forces de pression, même si elles sont adiabatiques et imperméables.",
    ],
    correctIndex: 1,
  },
  {
  ...
  // ─── Leçon 4 : Premier principe ───
  {
    ...
    choices: [
      ...
      "Parce que chaleur et travail ne se conservent pas, alors que l'énergie interne du système se conserve dans toute transformation.",
    ],
    explanations: [
      ...
      "Faux : U peut varier. U est une fonction d'état, tandis que Q et W dépendent du chemin suivi ; c'est cette distinction que traduit la notation.",
    ],
    correctIndex: 0,
  },
  {
    ...
    choices: [
      ...
      "Il est nul seulement si le cycle est quasi-statique.",
    ],
    explanations: [
      ...
      "Faux : tout cycle ramène le système à son état initial. ΔU_cycle = 0 impose Q_cycle + W_cycle = 0, même si le cycle n'est pas quasi-statique.",
    ],
    correctIndex: 1,
  },
  {
  ...
  },
  {
    id: "l4-q6",
    lecon: 4,
    question: "Lors d'une transformation isochore d'un système fermé, avec pour seul travail celui des forces de pression, on a toujours :",
    choices: [
      "W = 0, donc ΔU = Q",
      "Q = 0, donc ΔU = W",
      "ΔU = 0, donc Q = -W",
    ...
    explanations: [
      "Exact : à volume constant, le travail des forces de pression est nul. C'est ici le seul travail, donc W = 0 et ΔU = Q.",
  ...
  // ─── Leçon 5 : Application au gaz parfait ───
  {
    ...
    choices: [
      ...
      "Inchangée",
      "Impossible à déterminer sans connaître le volume final",
    ],
    explanations: [
      ...
      "Faux : le volume final n'est pas nécessaire. Q = W = 0 impose ΔU = 0 ; pour un gaz parfait, la température reste donc inchangée.",
    ],
    correctIndex: 2,
  },
  {
  ...
  },
  {
    ...
    explanations: [
      ...
      "Faux : isotherme ne signifie pas adiabatique. Pour ce gaz parfait, ΔU = 0 impose Q = -W > 0 : la chaleur reçue compense le travail fourni.",
    ],
    correctIndex: 0,
  },
  {
    ...
    choices: [
      ...
      "Les deux courbes ont la même pente initiale puisqu'elles partent du même état",
      "L'adiabatique est plus raide que l'isotherme dans le diagramme (P,V), la pression y chute plus vite et le gaz refroidit",
      "Le gaz conserve sa température pendant la détente adiabatique puisqu'il n'échange pas de chaleur",
    ],
    explanations: [
      "Faux : c'est l'adiabatique qui est la plus raide, puisque |−γP/V| > |−P/V| lorsque γ > 1.",
      "Faux : au même état, les pentes valent -P/V pour l'isotherme et -γP/V pour l'adiabatique. Un point commun n'impose pas une tangente commune.",
      ...
      "Faux : Q = 0 n'empêche pas une variation d'énergie interne. Le gaz fournit du travail : ΔU = W < 0, donc sa température diminue.",
    ],
    correctIndex: 2,
  },
  {
  ...
  },
  {
    ...
    choices: [
      ...
      "La transformation est isotherme puisque les températures initiale et finale sont égales",
    ...
    explanations: [
      ...
      "Faux : T_C = T_B ne concerne que les extrémités du trajet. Sur le segment de droite, le produit PV varie ; la température n'est donc pas constante.",
